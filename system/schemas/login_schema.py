...
from core.exception import ModelValidatorException
from schemas.menu_schema import MenuModel
...
class UserLoginJson(BaseModel):
    ...
    code: Optional[str] = Field(default=None, description='验证码')
    uuid: Optional[str] = Field(default=None, description='会话编号')
    login_info: Optional[dict] = Field(default=None, description='登录信息')
