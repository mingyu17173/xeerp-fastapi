...
from core.enums import BusinessType, RedisInitKeyConfig
...
from schemas.login_schema import UserLogin, UserLoginJson, UserRegister, Token
...
async def login_json(
    ...
    user = UserLogin(
        ...
        login_info=login_data.login_info,
    ...
    await UserService.edit_user_services(request,
