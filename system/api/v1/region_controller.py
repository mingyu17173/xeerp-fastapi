...
regionRoute = APIRouter(prefix='/system/region', dependencies=[Depends(LoginService.get_current_user)])

@regionRoute.get(
    '/list',
    response_model=PageResponseModel,
    dependencies=[Depends(CheckUserInterfaceAuth('system:region:list'))]
)
...
@regionRoute.post('', dependencies=[Depends(CheckUserInterfaceAuth('system:region:add'))])
...
@regionRoute.put('', dependencies=[Depends(CheckUserInterfaceAuth('system:region:edit'))])
...
@regionRoute.delete('/{ids}', dependencies=[Depends(CheckUserInterfaceAuth('system:region:remove'))])
...
@regionRoute.get(
    ...
    dependencies=[Depends(CheckUserInterfaceAuth('system:region:query'))]
)
...
@regionRoute.post('/export', dependencies=[Depends(CheckUserInterfaceAuth('system:region:export'))])
