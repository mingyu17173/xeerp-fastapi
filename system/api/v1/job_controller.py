...
jobRoute = APIRouter(prefix='/monitor', dependencies=[Depends(LoginService.get_current_user)])
...
@jobRoute.post('/job', dependencies=[Depends(CheckUserInterfaceAuth('monitor:job:add'))])
...
@jobRoute.put('/job', dependencies=[Depends(CheckUserInterfaceAuth('monitor:job:edit'))])
...
@jobRoute.delete('/job/{job_ids}', dependencies=[Depends(CheckUserInterfaceAuth('monitor:job:remove'))])
...
@jobRoute.post(
    '/job/export', 
    dependencies=[Depends(CheckUserInterfaceAuth('monitor:job:export'))]
)
...
@jobRoute.delete('/jobLog/clean', dependencies=[Depends(CheckUserInterfaceAuth('monitor:job:remove'))])
...
@jobRoute.delete('/jobLog/{job_log_ids}', dependencies=[Depends(CheckUserInterfaceAuth('monitor:job:remove'))])
...
@jobRoute.post('/jobLog/export', dependencies=[Depends(CheckUserInterfaceAuth('monitor:job:export'))])
