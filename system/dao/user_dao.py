...
from models.role import SysRole, SysRoleDept, SysRoleMenu  # noqa: F401
from models.user import SysUser, SysUserPost, SysUserRole
...
class UserDao:
    ...
    @classmethod
    async def get_user_by_all_list(cls, db: AsyncSession):
        """
        根据user_id列表获取用户信息

        :param db: orm对象
        :return: 当前user_id列表的用户信息对象列表
        """
        query_user_info = (
            (
                await db.execute(
