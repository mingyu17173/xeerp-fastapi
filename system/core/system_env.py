...
class AppSettings(BaseSettings):
    ...
    app_service_id: Optional[str] = "system-8001"
    app_root_path: str = ''
...
class DataBaseSettings(BaseSettings):
    ...
    db_database: str = 'xeerp'
    db_echo: bool = True # 是否打印SQL（开发开启）
...
class RedisSettings(BaseSettings):
    ...
    redis_port: int = 6379
    redis_username: str = ""  # Redis 6+ 用户名（没有留空）
    redis_password: str = ""  # 密码（没有留空）
...
class GenSettings:
    ...
    author = 'insistence'
    package_name = 'api.system'
    auto_remove_pre = False
    table_prefix = 'sys_'
    allow_overwrite = False

    GEN_PATH = 'static/gen_path'
...
class UploadSettings:
    ...
    UPLOAD_PATH = 'static'
    UPLOAD_BASE_PATH: str = os.path.join(AppSettings().BASE_DIR, "/static/uploads")
