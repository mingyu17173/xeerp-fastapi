        ...
        <el-drawer title="条件设置" v-model="drawer" destroy-on-close append-to-body :size="600">
            ...
            <el-container>
                <el-main style="padding: 0 20px 20px 20px">
                    ...
                    <el-button style="width: 100%" type="info" icon="plus" text bg @click="addConditionGroup">添加条件组
                    </el-button>
                </el-main>
                <el-footer>
...
<script setup>
    ...
    const delTerm = (index) => {
        ...
        if (state.nodeConfig.conditionNodes.length == 1) {
            ...
            emit('update:modelValue', state.nodeConfig.conditionNodes[0].childNode)
        }
    }
    ...
    const arrTransfer = (index, type = 1) => {
        ...
        emit('update:modelValue', this.nodeConfig)
    }
    ...
    const addConditionGroup = () => {
        proxy.addConditionList(state.form.conditionList[state.form.conditionList.push([]) - 1])
    }
