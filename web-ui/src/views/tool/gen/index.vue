        ...
        <el-dialog :title="preview.title" v-model="preview.open" width="80%" top="5vh" append-to-body class="scrollbar">
            <el-tabs v-model="preview.activeName">
                <el-tab-pane
                        ...
                        :label="key.substring(key.lastIndexOf('/')+4,key.indexOf('.vm'))"
                        :name="key.substring(key.lastIndexOf('/')+4,key.indexOf('.vm'))"
                        :key="value"
                >
...
<script setup name="Gen">
    ...
    function handleGenTable(row) {
        ...
        if (row.genType === "1") {
            ...
            proxy.$download.zip("/tool/gen/batchGenCode?tables=" + tbNames, "zeapp.zip");
        }
    }
