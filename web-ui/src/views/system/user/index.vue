<template>
    <div class="app-container" style="padding:0px;">
        <el-row :gutter="20" style="margin:0px;" >
            <!--部门数据-->
            <el-col :span="4" :xs="24" style="padding: 24px; height: calc(100vh - 94px); border-right: 8px solid #f7f7f7;">
            ...
            <!--用户数据-->
            <el-col :span="20" :xs="24" style="padding: 24px;">
                ...
                <el-table v-loading="loading" :data="userList" border stripe show-header highlight-current-row
                    ...
                    <el-table-column label="操作" align="center" width="150" class-name="small-padding fixed-width">
                        <template #default="scope">
                            ...
                            <el-tooltip content="分配角色" placement="top" v-if="scope.row.user_id !== 1">
        ...
        <Derive v-model:isOpen="isOpen" @closehan="closehandle"/>
