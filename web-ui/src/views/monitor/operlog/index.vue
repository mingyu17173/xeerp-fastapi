<template>
    <div class="app-container">
        ...
        <el-table ref="operlogRef" v-loading="loading" :data="operlogList" border stripe show-header
                  highlight-current-row @selection-change="handleSelectionChange"
                  :default-sort="defaultSort" @sort-change="handleSortChange">
            <el-table-column type="selection" width="50" align="center"/>
            <el-table-column label="日志编号" align="center" prop="operId" width="90"/>
            <el-table-column label="系统模块" align="center" prop="title" width="120" :show-overflow-tooltip="true"/>
            ...
            <el-table-column label="操作地址" align="center" prop="operUrl" :show-overflow-tooltip="true"/>
            <el-table-column label="操作状态" align="center" prop="status"  width="120">
                <template #default="scope">
            ...
            <el-table-column label="消耗时间" align="center" prop="cost_time" width="110" :show-overflow-tooltip="true"
                             sortable="custom" :sort-orders="['descending', 'ascending']">
                <template #default="scope">
        ...
        <el-dialog title="操作日志详细" v-model="open" width="800px" append-to-body>
            <el-form :model="form" label-width="100px">
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-form-item label="消耗时间：">{{ form.cost_Time }}毫秒</el-form-item>
                    </el-col>
                    <el-col :span="8">
...
<script setup name="Operlog">
    ...
    function typeFormat(row, column) {
        return proxy.selectDictLabel(sys_oper_type.value, row.business_type);
    }
