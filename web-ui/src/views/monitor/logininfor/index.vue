<template>
    <div class="app-container">
        ...
        <el-table ref="logininforRef" v-loading="loading" :data="logininforList" border stripe show-header
            ...
            <el-table-column label="操作系统" align="center" prop="os" width="160" :show-overflow-tooltip="true"/>
            <el-table-column label="浏览器" align="center" prop="browser" width="160" :show-overflow-tooltip="true"/>
            <el-table-column label="登录状态" align="center" prop="status" width="160">
...
<script setup name="Logininfor">
    ...
    function handleSelectionChange(selection) {
        ...
        selectName.value = selection.map(item => item.user_name);
    }
