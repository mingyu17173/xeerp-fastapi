...
async def lifespan(app: FastAPI):
    ...
    await init_db()
    logger.info("Purchase service started successfully")
    yield
    logger.info("Stopping purchase service...")

app = FastAPI(
    title="XEERP Purchase Service",
    description="采购服务",
...
async def health_check():
    logger.info("Purchase service health check")
